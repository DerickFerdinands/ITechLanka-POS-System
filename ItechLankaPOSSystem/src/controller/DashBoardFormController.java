...
public class DashBoardFormController {
    ...
    public void initialize() throws IOException {
        ...
        btnList.add(new DashboardButton(btnDashboard, imgDash, new Image("/Assets/image (25).png"), new Image("/Assets/image (4).png")));
        btnList.add(new DashboardButton(btnCustomer, imgCus, new Image("/Assets/image (26).png"), new Image("/Assets/image (6).png")));
        btnList.add(new DashboardButton(btnQuote, imgQuote, new Image("/Assets/image (27).png"), new Image("/Assets/image (7).png")));
        btnList.add(new DashboardButton(btnOrders, imgOrder, new Image("/Assets/image (28).png"), new Image("/Assets/image (10).png")));
        btnList.add(new DashboardButton(btnPackages, imgPackage, new Image("/Assets/image (29).png"), new Image("/Assets/image (11).png")));
        btnList.add(new DashboardButton(btnItem, imgItem, new Image("/Assets/image (30).png"), new Image("/Assets/image (14).png")));
        btnList.add(new DashboardButton(btnDIrector, imgDirector, new Image("/Assets/image (31).png"), new Image("/Assets/image (15).png")));
        btnList.add(new DashboardButton(btnSupplier, imgSupply, new Image("/Assets/image (32).png"), new Image("/Assets/image (18).png")));
        btnList.add(new DashboardButton(btnReport, imgReport, new Image("/Assets/image (33).png"), new Image("/Assets/image (19).png")));
        btnList.add(new DashboardButton(btnProfit, imgProfit, new Image("/Assets/image (34).png"), new Image("/Assets/image (22).png")));
        btnList.add(new DashboardButton(btnSettings, imgSettings, new Image("/Assets/image (35).png"), new Image("/Assets/image (23).png")));
